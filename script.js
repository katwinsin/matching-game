...
function shuffleCardImageClasses() {
  ...
  let shuffleCardImageClasses = _.shuffle(cardClasses);
...
return shuffleCardImageClasses;
}
...
let cardContainer = document.getElementById("card-container");
  ...
  let flipCounterElement = document.getElementById("flip-count");
  flipCounterElement.textContent = "0";

  let matchCounterElement =
